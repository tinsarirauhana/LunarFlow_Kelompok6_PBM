...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    final screenHeight = MediaQuery.of(context).size.height; // ← tambah ini

    return Scaffold(
      body: Stack(
        fit: StackFit.expand, // ← sama seperti login
        children: [
          ...
          SingleChildScrollView(
            child: ConstrainedBox(
              constraints: BoxConstraints(minHeight: screenHeight), // ← kunci
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLabel(
                        'Buat Kata Sandi (min. 8 buah karakter bebas)'),
                    const SizedBox(height: 8),
                    TextField(
